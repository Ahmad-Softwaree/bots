...
export default function BotContent({ data }: { data: Bot }) {
  const t = useTranslations("bot_detail");
  const bot_t = useTranslations("bot");

  const isActive = data.status === "active";
  const formattedDate = dayjs(data.createdAt).format("MMMM D, YYYY");
                  ...
                  <div className="flex flex-wrap items-center gap-3">
                    <BadgeScaleMotion>
                      <Badge variant={isActive ? "default" : "destructive"}>
                        ...
                        {isActive ? bot_t("active") : bot_t("down")}
                      </Badge>
                    </BadgeScaleMotion>
